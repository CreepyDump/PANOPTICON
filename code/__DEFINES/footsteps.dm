...
GLOBAL_LIST_INIT(footstep, list(
	FOOTSTEP_WOOD = list(list(
		...
		'sound/foley/footsteps/FTWOO_A3.ogg'), 100, 0),
	...
	FOOTSTEP_MUD = list(list(
		...
		'sound/foley/footsteps/FTMUD (5).ogg'), 85, 0),
