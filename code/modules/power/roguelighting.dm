...
/obj/effect/sunlight/Initialize()
	light_color = pick("#941616", "#ce4d4d", "#df4e4e", "#9c5454", "#d83a3a", "#9b3e3e")
	..()
...
/obj/effect/sunlight/proc/update()
	...
	switch(mode)
		if("night")
			light_color = pick("#180a0a", "#120404", "#110000")
		if("dusk")
			light_color = pick("#ac3e3e", "#833726", "#821217")
		if("dawn")
			light_color = pick("#773939", "#5B3B37", "#381914")
		if("day")
			light_color = pick("#941616", "#ce4d4d", "#df4e4e", "#9c5454", "#d83a3a", "#9b3e3e")
