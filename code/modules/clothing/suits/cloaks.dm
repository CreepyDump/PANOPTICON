...
/obj/item/clothing/suit/hooded/cloak/goliath
	...
	armor = list("blunt" = 35, "bullet" = 10, "laser" = 25, "energy" = 10, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 60, "acid" = 60) //a fair alternative to bone armor, requiring alternative materials and gaining a suit slot
...
/obj/item/clothing/head/hooded/cloakhood/goliath
	...
	icon_state = "golhood"
	desc = ""
	armor = list("blunt" = 35, "bullet" = 10, "laser" = 25, "energy" = 10, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 60, "acid" = 60)
...
/obj/item/clothing/suit/hooded/cloak/drake
	...
	armor = list("blunt" = 70, "bullet" = 30, "laser" = 50, "energy" = 40, "bomb" = 70, "bio" = 60, "rad" = 50, "fire" = 100, "acid" = 100)
