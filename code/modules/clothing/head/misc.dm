...
/obj/item/clothing/head/hunter
	...
	icon_state = "hunter"
	item_state = "hunter"
	armor = list("blunt" = 5, "slash" = 5, "stab" = 5, "bullet" = 5, "laser" = 5, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/head/crown
	...
	desc = ""
	icon_state = "crown"
	armor = list("blunt" = 15, "slash" = 15, "stab" = 15, "bullet" = 0, "laser" = 0,"energy" = 15, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 50)
