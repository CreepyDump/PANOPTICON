/datum/job/panopticon/baryga
	...
	outfit = /datum/outfit/job/panopticon/baryga
...
/datum/job/panopticon/baryga/New()
	. = ..()
	peopleknowme = list("Strafbat")
	peopleiknow = list("Strafbat")

/datum/outfit/job/panopticon/baryga/pre_equip(mob/living/carbon/human/H)
	..()
...
/datum/outfit/job/panopticon/baryga
	uniform = null
	id = null
	ears = null
	belt = null
