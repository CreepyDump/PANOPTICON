...
/obj/item/gun/ballistic/automatic/pistol/knuckleshot
	name = "Knuckleshot"
	desc = ""
	icon = 'icons/panopticon/items/guns.dmi'
	icon_state = "knuckleshot"
	w_class = WEIGHT_CLASS_NORMAL
	mag_type = /obj/item/ammo_box/magazine/m10mm
	can_suppress = FALSE
	recoil = 1
	fire_sound = 'sound/combat/Ranged/handgun-fire-01.ogg'
	dry_fire_sound = 'sound/combat/Ranged/handgun-dry-01.ogg'
	load_sound = 'sound/combat/Ranged/handgun-load-01.ogg'
	load_empty_sound = 'sound/combat/Ranged/handgun-load-01.ogg'
	eject_sound = 'sound/combat/Ranged/handgun-eject-01.ogg'
	eject_empty_sound = 'sound/combat/Ranged/handgun-eject-01.ogg'
