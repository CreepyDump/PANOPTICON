...
/obj/item/gun/ballistic/rifle/gusyevboltovka/getonmobprop(tag)
	...
	if(tag)
		switch(tag)
			if("gen")
				return list("shrink" = 0.9,"sx" = 1,"sy" = -3,"nx" = 0,"ny" = -3,"wx" = -8,"wy" = 3,"ex" = 7,"ey" = 0,"northabove" = 0,"southabove" = 1,"eastabove" = 1,"westabove" = 0,"nturn" = 40,"sturn" = -40,"wturn" = 0,"eturn" = 15,"nflip" = 0,"sflip" = 4,"wflip" = 8,"eflip" = 0,)
			if("wielded")
