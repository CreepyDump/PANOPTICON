...
/datum/antagonist/maniac/proc/handle_object_hallucination(mob/living/dreamer)
	...
	var/static/list/speech_sounds = list(
		'sound/misc/mantalk (2).ogg',
		'sound/misc/occulttalk (1).ogg',
		'sound/misc/occulttalk (2).ogg',
		'sound/misc/odonghtalk.ogg',
		'sound/misc/retardtalk (1).ogg',
		'sound/misc/retardtalk (2).ogg',
		'sound/misc/womantalk (1).ogg',
		'sound/misc/womantalk (2).ogg',
		'sound/misc/mantalk (1).ogg'
	)
