...
/datum/antagonist/vampire/on_gain()
	...
	owner.current.cmode_music = 'sound/music/combat/desperation.ogg'
...
/mob/living/carbon/human/proc/vampire_infect()
	...
	src.playsound_local(get_turf(src), 'sound/blank.ogg')
...
//	stop_all_loops()
	...
	if(client)
		to_chat(client, span_bigbold(span_suicide("You are dead! You can respawn by clicking 'Leave the cruel world' verb in the 'Filth' tab.")))
		...
		client.screen += H
		H.Fade()
		addtimer(CALLBACK(H, /atom/movable/screen/gameover/proc/Fade, TRUE), 100)
