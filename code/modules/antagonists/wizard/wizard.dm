...
/datum/antagonist/wizard/proc/rename_wizard()
	...
	var/newname = copytext_char(sanitize_name(input(wiz_mob, "You are the [name]. Would you like to change my name to something else?", "Name change", randomname) as null|text),1,MAX_NAME_LEN)
