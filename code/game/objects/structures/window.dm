...
/obj/structure/window/rcd_act(mob/user, obj/item/construction/rcd/the_rcd)
	switch(the_rcd.mode)
		if(RCD_DECONSTRUCT)
			to_chat(user, "<span class='notice'>I deconstruct the window.</span>")
			qdel(src)
			return TRUE
	return FALSE
...
/obj/structure/window/reinforced
	...
	armor = list("blunt" = 80, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 25, "bio" = 100, "rad" = 100, "fire" = 80, "acid" = 100)
	max_integrity = 75
	explosion_block = 1
...
/obj/structure/window/plasma
	...
	armor = list("blunt" = 80, "bullet" = 5, "laser" = 0, "energy" = 0, "bomb" = 45, "bio" = 100, "rad" = 100, "fire" = 99, "acid" = 100)
	max_integrity = 200
	explosion_block = 1
...
/obj/structure/window/plasma/reinforced
	...
	armor = list("blunt" = 80, "bullet" = 20, "laser" = 0, "energy" = 0, "bomb" = 60, "bio" = 100, "rad" = 100, "fire" = 99, "acid" = 100)
	max_integrity = 500
...
/obj/structure/window/shuttle
	...
	reinf = TRUE
	heat_resistance = 1600
	armor = list("blunt" = 90, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 50, "bio" = 100, "rad" = 100, "fire" = 80, "acid" = 100)
	smooth = SMOOTH_TRUE
	canSmoothWith = null
	explosion_block = 3
	level = 3
...
/obj/structure/window/plasma/reinforced/plastitanium
	...
	flags_1 = PREVENT_CLICK_UNDER_1
	heat_resistance = 1600
	armor = list("blunt" = 95, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 50, "bio" = 100, "rad" = 100, "fire" = 80, "acid" = 100)
	smooth = SMOOTH_TRUE
	canSmoothWith = null
	explosion_block = 3
