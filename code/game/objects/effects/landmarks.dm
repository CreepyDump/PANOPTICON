...
/obj/effect/landmark/start/slugslate
	name = "Slugslate"
	icon_state = "arrow"
	jobspawn_override = list("Slug")
	delete_after_roundstart = FALSE

/obj/effect/landmark/start/slugsspawn
	name = "Slugs"
	icon_state = "arrow"
	jobspawn_override = list("Slug")
...
/obj/effect/landmark/start/lesnik
	name = "Lesnik"
	icon_state = "arrow"
	jobspawn_override = list("Lesnik")
	delete_after_roundstart = FALSE

/obj/effect/landmark/start/zek
	name = "Zek"
	icon_state = "arrow"
	jobspawn_override = list("Zek")
	delete_after_roundstart = FALSE

/obj/effect/landmark/start/nomad
	name = "Nomad"
	icon_state = "arrow"
	jobspawn_override = list("Nomad")
	delete_after_roundstart = FALSE
