...
/obj/item/stack/sheet/animalhide/attackby(obj/item/W, mob/user, params)
	if(W.get_sharpness())
		...
		user.visible_message("<span class='notice'>[user] starts cutting hair off \the [src].</span>", "<span class='notice'>I start cutting the hair off \the [src]...</span>", "<span class='hear'>I hear the sound of a knife rubbing against flesh.</span>")
