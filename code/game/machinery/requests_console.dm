...
/obj/machinery/requests_console
	...
	max_integrity = 300
	armor = list("blunt" = 70, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 90, "acid" = 90)
...
/obj/machinery/requests_console/Topic(href, href_list)
	...
	if(reject_bad_text(href_list["write"]))
		...
		var/new_message = (to_department in GLOB.req_console_ckey_departments) && copytext_char(reject_bad_text(input(usr, "Write your message:", "Awaiting Input", "")),1,MAX_MESSAGE_LEN)
		if(new_message)
...
/obj/machinery/requests_console/say_mod(input, message_mode)
	var/ending = copytext_char(input, length(input) - 2)
	if (ending == "!!!")
		. = "blares"
	else
		. = ..()
