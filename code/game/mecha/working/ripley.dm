/obj/mecha/working/ripley
	...
	lights_power = 7
	deflect_chance = 15
	armor = list("blunt" = 40, "bullet" = 20, "laser" = 10, "energy" = 20, "bomb" = 40, "bio" = 0, "rad" = 20, "fire" = 100, "acid" = 100)
	max_equip = 6
...
/obj/mecha/working/ripley/Initialize()
	. = ..()
	AddComponent(/datum/component/armor_plate,3,/obj/item/stack/sheet/animalhide/goliath_hide,list("blunt" = 10, "bullet" = 5, "laser" = 5))
...
/obj/mecha/working/ripley/mkii
	...
	step_in = 4
	armor = list("blunt" = 40, "bullet" = 20, "laser" = 10, "energy" = 20, "bomb" = 40, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 100)
...
/obj/mecha/working/ripley/firefighter
	...
	lights_power = 7
	armor = list("blunt" = 40, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = 60, "bio" = 0, "rad" = 70, "fire" = 100, "acid" = 100)
