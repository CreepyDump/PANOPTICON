...
//	var/round_end_sound = pick(1,2,3)
...
//			if(2)
//				thing << sound('sound/misc/end3.ogg')
//			if(3)
//				thing << sound('sound/misc/end4.ogg')

		thing << sound('sound/misc/roundend.ogg')
	to_chat(world, "Please be patient as the server restarts. You will be automatically reconnected in about 10 seconds.")
	sleep(6 SECONDS)
//	switch(round_end_sound)
//		if(1)
//			sleep(51 SECONDS)
...
//			sleep(45 SECONDS)
	...
	if(TgsAvailable())
		send2chat(new /datum/tgs_message_content("# Round end."), CONFIG_GET(string/chat_announce_new_game))
...
//	s += "! <b>UPDATE 4.4</b> 4/22/2022<br><br>"
	...
	if (players > 1)
		s += "[players][popcaptext] victims<br>"
	else if (players > 0)
		s += "[players][popcaptext] victim<br>"
	if (!host && hostedby)
