...
/mob/MouseEntered(location,control,params)
	...
	if(ismob(usr) && !nomouseover && name)
		...
		if(p.client)
			...
			p.client.mouseovertext.maptext = {"<span style='font-size:8pt;font-family:"JSL Ancient";color:[mousecolor];text-shadow:0 0 10px #fff, 0 0 20px #fff, 0 0 30px #e60073, 0 0 40px #e60073, 0 0 50px #e60073, 0 0 60px #e60073, 0 0 70px #e60073;' class='center maptext '>[name]"}
	...
	if(ismob(usr) && !nomouseover && name)
		...
		if(p.client)
			...
			if(!isturf(loc))
				...
				p.client.mouseovertext.movethis(PM)
			p.client.mouseovertext.maptext = {"<span style='font-size:8pt;font-family:"JSL Ancient";color:#ddd7df;text-shadow:0 0 10px #fff, 0 0 20px #fff, 0 0 30px #e60073, 0 0 40px #e60073, 0 0 50px #e60073, 0 0 60px #e60073, 0 0 70px #e60073;' class='center maptext '>[name]"}
			p.client.screen |= p.client.mouseovertext
	...
	if(ismob(usr) && !nomouseover && name)
		...
		if(p.client)
			...
			if(offset_x < 1 || offset_x > 15 || offset_y < 1 || offset_x > 15)
				return
			var/list/PM = list("screen-loc" = "[offset_x]:0,[offset_y]:0")
			p.client.mouseovertext.maptext = {"<span style='font-size:8pt;font-family:"JSL Ancient";color:#607d65;text-shadow:0 0 10px #fff, 0 0 20px #fff, 0 0 30px #e60073, 0 0 40px #e60073, 0 0 50px #e60073, 0 0 60px #e60073, 0 0 70px #e60073;' class='center maptext '>[name]"}
			p.client.mouseovertext.movethis(PM)
			p.client.screen |= p.client.mouseovertext
...
/turf/open/MouseEntered(location,control,params)
	...
	if(ismob(usr) && !nomouseover && name)
		...
		if(p.client)
			...
			var/offset_y = 8 - (p.y - y)
			var/list/PM = list("screen-loc" = "[offset_x]:0,[offset_y]:0")
			p.client.mouseovertext.maptext = {"<span style='font-size:8pt;font-family:"JSL Ancient";color:#6b3f3f;text-shadow:0 0 10px #fff, 0 0 20px #fff, 0 0 30px #e60073, 0 0 40px #e60073, 0 0 50px #e60073, 0 0 60px #e60073, 0 0 70px #e60073;' class='center maptext '>[name]"}
			p.client.mouseovertext.movethis(PM)
			p.client.screen |= p.client.mouseovertext
