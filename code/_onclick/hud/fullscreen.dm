...
/atom/movable/screen/fullscreen/panopticontitle
	icon = 'icons/mob/screen_full.dmi'
	screen_loc = "1,1"
	icon_state = "panoptic_title"
	alpha = 255

/atom/movable/screen/fullscreen/narcos
	icon = 'icons/mob/screen_full.dmi'
	screen_loc = "1,1"
	icon_state = "narcos"
	alpha = 100
...
/atom/movable/screen/fullscreen/maniac/update_for_view(client_view)
	screen_loc = "CENTER-7,CENTER-7"
	lolz = rand(1, 13)
	update_icon()

/atom/movable/screen/fullscreen/maniac/update_icon_state()
	. = ..()
