...
//			manifest_inject(N.new_character, N.client)
			if(N.new_character.real_name)
				GLOB.character_list[N.new_character.mobid] = "[N.ckey] was [N.new_character.real_name] ([N.new_character.mind.assigned_role])<BR>"
				GLOB.character_ckey_list[N.new_character.real_name] = N.ckey
			else
				log_game("GAME SETUP: MANIFEST BIG ERROR")
			log_character("[N.ckey] - [N.new_character.real_name] - [N.new_character.mind.assigned_role]")
